...
static char s_font_dir[512]         = "./share/font";
static char s_font_regular[512]     = "./share/font/AlibabaPuHuiTi-3-55-Regular.ttf";
static char s_font_mono[512]        = "./share/font/LiberationMono-Regular.ttf";
...
void hal_paths_init(const char *exe_dir)
{
    ...
    snprintf(s_font_dir,         sizeof(s_font_dir),         "%s/share/font", exe_dir);
    snprintf(s_font_regular,     sizeof(s_font_regular),     "%s/share/font/AlibabaPuHuiTi-3-55-Regular.ttf", exe_dir);
    snprintf(s_font_mono,        sizeof(s_font_mono),        "%s/share/font/LiberationMono-Regular.ttf", exe_dir);
